...
installed plugin. Returns per-check `pass`/`warn`/`fail` plus prioritized
next steps.

> The full, always-current list of all plugins and tools lives in
> [`docs/PLUGIN_REFERENCE.md`](docs/PLUGIN_REFERENCE.md), generated by
> `python scripts/gen_plugin_reference.py`.
